 ...
 * @author Bruno Arley
 */
@WebServlet(name = "Alu_Edita", urlPatterns = {"/Alu_Edita"})
public class Alu_Edita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            aluguel = alu.buscar(Integer.parseInt(request.getParameter("codigo")));
            Imovel imovel = new Imovel();
            DaoImovel imo = new DaoImovel();
            String cod_imo = request.getParameter("cod_imo");
            imovel.setImo_cod(Integer.parseInt(cod_imo.replace(" ", "")));

            inquilino.setInq_cod(aluguel.getAlu_inq_cod());
            ...
            if (nDigVerific.equals(nDigResult)) {
                ...
                request.getSession().setAttribute("Mensagem", "Aluguel Alterado com Sucesso");
