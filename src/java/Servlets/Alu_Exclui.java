 ...
 * @author Bruno Arley
 */
@WebServlet(name = "Alu_Exclui", urlPatterns = {"/Alu_Exclui"})
public class Alu_Exclui extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            aluguel = alu.buscar(Integer.parseInt(request.getParameter("cod")));
           ...
           request.getSession().setAttribute("Mensagem", "Aluguel Excluido com Sucesso");
