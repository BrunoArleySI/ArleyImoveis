...
@WebServlet(name = "Imo_Cadastra", urlPatterns = {"/Imo_Cadastra"})
public class Imo_Cadastra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            endereco.setEnd_cod(end.listar().size()+1);
            
           
   
            out.print(endereco.getEnd_cod());
            imovel.setImo_cod_end(endereco.getEnd_cod());
           ...
           imovel.setImo_valor(Float.parseFloat(request.getParameter("valor")));
            ...
            imovel.setImo_cod(imo.listar().size()+1);
            
            end.cadastra(endereco);
            imo.cadastra(imovel);
            
            
            
            request.getSession().setAttribute("Mensagem", "Imovel Cadastrado com Sucesso");
