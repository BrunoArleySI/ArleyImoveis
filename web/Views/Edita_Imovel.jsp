<%-- 
    Document   : Edita_Imovel
    Created on : 07/11/2018, 22:11:19
    Author     : Bruno
--%>
...
<html lang="pt-br">
    ...
    <body style=" background: url('../Sources/Images/fundo005.jpg') center center no-repeat fixed; 
        ...
        <%
            ...
            int cod_imo = Integer.parseInt(request.getParameter("cod_imo"));

            imovel = imo.buscar(cod_imo);
...
<button type="submit"  class=" navbar-right btn btn-danger navbar-btn" aria-hidden="true" data-toggle="modal" data-target=".bs-example-modal-lg8"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>&nbsp; Sair</button>
        ...
        <div class="jumbotron" style=" box-shadow: 0px 0px 1em #666; -webkit-box-shadow: 4px 4px 1em #666; -moz-box-shadow: 0px 0px 1em #666; width: 90%; border-radius: 15px; top: 10%; left: 5%; position: absolute;">
            <div class="container">
                <center>
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action="../Imo_Edita" method="post">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label" style="width: 30%;" >Codigo Do Imovel</label>
                                            <div class="col-sm-8" style="width: 54%;">
                                                <input type="text" required name="codigo" value="<%out.print(imovel.getImo_cod()); %>" class="form-control"  id="disabledInput" placeholder="Rua do Imovel" readonly>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Estado</label>
                                            <div class="col-sm-8">
                                                <input type="text" required name="estado" value="<%out.print(endereco.getEnd_estado()); %>" class="form-control" id="inputEmail3" placeholder="Estado do imovel">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Cidade</label>
                                            <div class="col-sm-8">
                                                <input type="text" required name="cidade" value="<%out.print(endereco.getEnd_cidade()); %>" class="form-control" id="inputEmail3" placeholder="Cidade do Imovel">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Bairro</label>
                                            <div class="col-sm-8">
                                                <input type="text" required name="bairro" value="<%out.print(endereco.getEnd_bairro()); %>" class="form-control" id="inputEmail3" placeholder="Bairro do Imovel">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" required name="rua" value="<%out.print(endereco.getEnd_rua()); %>" class="form-control" id="inputEmail3" placeholder="Rua do Imovel">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Numero</label>
                                            <div class="col-sm-8">
                                                <input type="text" value="<%out.print(endereco.getEnd_numero()); %>" required name="numero" class="form-control" id="inputEmail3" placeholder="Numero do Imovel / Andar">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" required class="form-control" value="<%out.print(endereco.getEnd_cep()); %>" name="cep" id="inputEmail3" placeholder="Cep do Imovel">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8" >
                                                <input type="text" required name="descricao" value="<%out.print(imovel.getImo_desc()); %>" class="form-control" id="inputEmail3" placeholder="Descrição do Imovel / Ex : Numero do andar">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Valor</label>
                                            <div class="col-sm-8" style="width: 35%;">
                                                <input type="text"  required="required" pattern="([0-9]{0,15})?([0-9]{0,1})?[0-9]{0,1}.[0-9]{0,2}$" name="valor"  value="<%out.print(imovel.getImo_valor()); %>" class="form-control" id="inputEmail3" placeholder="Valor do Imovel">
                                        ...
                                        <div style="text-align: left; width: 20%;">
                                            <%
                                                ...
                                                for (int i = 0; i < ti.listar().size(); i++) {
                                                    if (ti.listar().get(i).getTi_cod() == imovel.getImo_tipo_cod()) {
